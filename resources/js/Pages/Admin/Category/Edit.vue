...
const submit = () => {
    router.post(`/admin/category/update/${props.category.id}`, {
        _method: "put",
            ...
            <div class="relative overflow-x-auto">
                <form @submit.prevent="submit" class="max-w-lg mx-auto">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="category_name" v-model="form.category_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                        <div class="text-red-400 text-sm" v-if="errors && errors.category_name">{{ errors.category_name }}</div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div v-if="props.category.image" class="mt-4">
                            <img :src="`/${props.category.image}`" alt="Current Image" class="w-32 h-32 object-cover rounded-lg border border-gray-300" />
                        </div>
                    </div>
